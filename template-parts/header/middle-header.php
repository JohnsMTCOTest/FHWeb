...
<div class="main-header <?php if( get_theme_mod( 'vw_church_sticky_header', false) == 1 || get_theme_mod( 'vw_church_stickyheader_hide_show', false) == 1) { ?> header-sticky"<?php } else { ?>close-sticky <?php } ?>">
  <div class="container">
    <div class="header-bg">
      <div class="row">
