...
function vw_church_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'vw_church_hide_show_topbar_section',array(
	  	'default' => 1,
	  	'transport' => 'refresh',
	  	'sanitize_callback' => 'vw_church_switch_sanitization'
  	));
  	$wp_customize->add_control( new VW_Church_Toggle_Switch_Custom_Control( $wp_customize, 'vw_church_hide_show_topbar_section',array(
	  	'label' => esc_html__( 'Show / Hide Topbar','vw-church' ),
	  	'section' => 'vw_church_header_section',
  	)));

	//Sticky Header
	$wp_customize->add_setting( 'vw_church_sticky_header',array(
      'default' => 0,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_church_switch_sanitization'
  	) );
  	$wp_customize->add_control( new VW_Church_Toggle_Switch_Custom_Control( $wp_customize, 'vw_church_sticky_header',array(
      'label' => esc_html__( 'Sticky Header','vw-church' ),
      'section' => 'vw_church_header_section'
  	)));
	...
	$wp_customize->add_section( 'vw_church_slidersettings' , array(
  	...
  	'description' => __('Free theme has 3 slides options, For unlimited slides and more options </br> <a class="go-pro-btn" target="blank" href="https://www.themescaliber.com/products/religion-wordpress-theme">GET PRO</a>','vw-church'),
		'panel' => 'vw_church_homepage_panel'
	) );
  ...
  $wp_customize->selective_refresh->add_partial('vw_church_slider_hide_show',array(
	...
	'choices' => array(
      '0' =>  esc_attr(__('0','vw-church')),
      '0.1' =>  esc_attr(__('0.1','vw-church')),
      '0.2' =>  esc_attr(__('0.2','vw-church')),
      '0.3' =>  esc_attr(__('0.3','vw-church')),
      '0.4' =>  esc_attr(__('0.4','vw-church')),
      '0.5' =>  esc_attr(__('0.5','vw-church')),
      '0.6' =>  esc_attr(__('0.6','vw-church')),
      '0.7' =>  esc_attr(__('0.7','vw-church')),
      '0.8' =>  esc_attr(__('0.8','vw-church')),
      '0.9' =>  esc_attr(__('0.9','vw-church'))
	),'active_callback' => 'vw_church_default_slider'
	));
	...
	$wp_customize->add_control('vw_church_about_btn',array(	
		'description' => "<a class='go-pro' target='_blank' href='https://www.themescaliber.com/products/religion-wordpress-theme'>More Info</a>",
		'section'=> 'vw_church_about',
		'type'=> 'hidden'
	));
	...
	$wp_customize->add_section('vw_church_events_section',array(
		...
		'description' => __('For more options of events section </br> <a class="go-pro-btn" target="blank" href="https://www.themescaliber.com/products/religion-wordpress-theme">GET PRO</a>','vw-church'),
		'panel' => 'vw_church_homepage_panel',
	));
	...
	$wp_customize->add_section('vw_church_footer',array(
		...
		'description' => __('For more options of footer section </br> <a class="go-pro-btn" target="blank" href="https://www.themescaliber.com/products/religion-wordpress-theme">GET PRO</a>','vw-church'),
		'panel' => 'vw_church_homepage_panel',
	));	
  ...
  $wp_customize->add_setting('vw_church_scroll_top_alignment',array(
    ...
    $wp_customize->add_setting('vw_church_align_footer_social_icon',array(
        'default' => 'center',
        'sanitize_callback' => 'vw_church_sanitize_choices'
	));
	$wp_customize->add_control('vw_church_align_footer_social_icon',array(
        'type' => 'select',
        'label' => __('Social Icon Alignment ','vw-church'),
        'section' => 'vw_church_footer',
        'choices' => array(
            'left' => __('Left','vw-church'),
            'right' => __('Right','vw-church'),
	...
	$wp_customize->add_setting( 'vw_church_copyright_sticky',array(
      'default' => 0,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_church_switch_sanitization'
    ) );
    $wp_customize->add_control( new VW_Church_Toggle_Switch_Custom_Control( $wp_customize, 'vw_church_copyright_sticky',array(
      'label' => esc_html__( 'Show / Hide Sticky Copyright','vw-church' ),
      'section' => 'vw_church_footer'
    )));

   $wp_customize->add_setting('vw_church_footer_social_icons_font_size',array(
       'default'=> 16,
       'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control('vw_church_footer_social_icons_font_size',array(
    'label' => __('Social Icon Font Size','vw-church'),
    	'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 1,
  ...
  $wp_customize->add_setting( 'vw_church_featured_image_border_radius', array(
	...
	$wp_customize->add_setting( 'vw_church_related_toggle_postdate',array(
	    'default' => 1,
	    'transport' => 'refresh',
	    'sanitize_callback' => 'vw_church_switch_sanitization'
  	));
  	$wp_customize->add_control( new VW_Church_Toggle_Switch_Custom_Control( $wp_customize, 'vw_church_related_toggle_postdate',array(
    'label' => esc_html__( 'Show / Hide Post Date','vw-church' ),
    'section' => 'vw_church_related_posts_settings'
  	)));

  	$wp_customize->add_setting('vw_church_related_postdate_icon',array(
	    'default' => 'fas fa-calendar-alt',
	    'sanitize_callback' => 'sanitize_text_field'
  	));
  	$wp_customize->add_control(new VW_Church_Fontawesome_Icon_Chooser(
  	$wp_customize,'vw_church_related_postdate_icon',array(
	    'label' => __('Add Post Date Icon','vw-church'),
	    'transport' => 'refresh',
	    'section' => 'vw_church_related_posts_settings',
	    'setting' => 'vw_church_related_postdate_icon',
	    'type'    => 'icon'
  	)));

	$wp_customize->add_setting( 'vw_church_related_toggle_author',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_church_switch_sanitization'
  	));
  	$wp_customize->add_control( new VW_Church_Toggle_Switch_Custom_Control( $wp_customize, 'vw_church_related_toggle_author',array(
		'label' => esc_html__( 'Show / Hide Author','vw-church' ),
		'section' => 'vw_church_related_posts_settings'
  	)));

  	$wp_customize->add_setting('vw_church_related_author_icon',array(
	    'default' => 'fas fa-user',
	    'sanitize_callback' => 'sanitize_text_field'
  	));
  	$wp_customize->add_control(new VW_Church_Fontawesome_Icon_Chooser(
  	$wp_customize,'vw_church_related_author_icon',array(
	    'label' => __('Add Author Icon','vw-church'),
	    'transport' => 'refresh',
	    'section' => 'vw_church_related_posts_settings',
	    'setting' => 'vw_church_related_author_icon',
	    'type'    => 'icon'
  	)));

	$wp_customize->add_setting( 'vw_church_related_toggle_comments',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_church_switch_sanitization'
  	) );
  	$wp_customize->add_control( new VW_Church_Toggle_Switch_Custom_Control( $wp_customize, 'vw_church_related_toggle_comments',array(
		'label' => esc_html__( 'Show / Hide Comments','vw-church' ),
		'section' => 'vw_church_related_posts_settings'
  	)));

  	$wp_customize->add_setting('vw_church_related_comments_icon',array(
	    'default' => 'fa fa-comments',
	    'sanitize_callback' => 'sanitize_text_field'
  	));
  	$wp_customize->add_control(new VW_Church_Fontawesome_Icon_Chooser(
  	$wp_customize,'vw_church_related_comments_icon',array(
	    'label' => __('Add Comments Icon','vw-church'),
	    'transport' => 'refresh',
	    'section' => 'vw_church_related_posts_settings',
	    'setting' => 'vw_church_related_comments_icon',
	    'type'    => 'icon'
  	)));

	$wp_customize->add_setting( 'vw_church_related_toggle_time',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_church_switch_sanitization'
  	) );
  	$wp_customize->add_control( new VW_Church_Toggle_Switch_Custom_Control( $wp_customize, 'vw_church_related_toggle_time',array(
		'label' => esc_html__( 'Show / Hide Time','vw-church' ),
		'section' => 'vw_church_related_posts_settings'
  	)));

  	$wp_customize->add_setting('vw_church_related_time_icon',array(
	    'default' => 'fas fa-clock',
	    'sanitize_callback' => 'sanitize_text_field'
  	));
  	$wp_customize->add_control(new VW_Church_Fontawesome_Icon_Chooser(
  	$wp_customize,'vw_church_related_time_icon',array(
	    'label' => __('Add Time Icon','vw-church'),
	    'transport' => 'refresh',
	    'section' => 'vw_church_related_posts_settings',
	    'setting' => 'vw_church_related_time_icon',
	    'type'    => 'icon'
  	)));

  	$wp_customize->add_setting('vw_church_related_post_meta_field_separator',array(
		'default'=> '|',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_church_related_post_meta_field_separator',array(
		'label'	=> __('Add Meta Separator','vw-church'),
		'description' => __('Add the seperator for meta box. Example: "|", "/", etc.','vw-church'),
		'section'=> 'vw_church_related_posts_settings',
		'type'=> 'text'
	...
	$wp_customize->add_setting( 'vw_church_related_image_hide_show',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_church_switch_sanitization'
	));
  	$wp_customize->add_control( new VW_Church_Toggle_Switch_Custom_Control( $wp_customize, 'vw_church_related_image_hide_show', array(
		'label' => esc_html__( 'Show / Hide Featured Image','vw-church' ),
		'section' => 'vw_church_related_posts_settings'
  	)));

  	$wp_customize->add_setting( 'vw_church_related_image_box_shadow', array(
		'default'              => '0',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_church_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_church_related_image_box_shadow', array(
		'label'       => esc_html__( 'Related post Image Box Shadow','vw-church' ),
		'section'     => 'vw_church_related_posts_settings',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
  	...
  	$wp_customize->add_setting('vw_church_related_button_text',array(
		'default'=> esc_html__('Read More','vw-church'),
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_church_related_button_text',array(
		'label'	=> esc_html__('Add Button Text','vw-church'),
		'input_attrs' => array(
      'placeholder' => esc_html__( 'Read More', 'vw-church' ),
        ),
  ...
  $wp_customize->add_setting( 'vw_church_single_blog_post_navigation_show_hide',array(
	...
	$wp_customize->add_setting( 'vw_church_singlepost_image_box_shadow', array(
		'default'              => '0',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_church_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_church_singlepost_image_box_shadow', array(
		'label'       => esc_html__( 'Single post Image Box Shadow','vw-church' ),
		'section'     => 'vw_church_single_blog_settings',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
  ...
  $wp_customize->add_control('vw_church_meta_field_single_separator',array(
	...
	$wp_customize->add_setting( 'vw_church_grid_image_hide_show',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_church_switch_sanitization'
	));
  	$wp_customize->add_control( new VW_Church_Toggle_Switch_Custom_Control( $wp_customize, 'vw_church_grid_image_hide_show', array(
		'label' => esc_html__( 'Show / Hide Featured Image','vw-church' ),
		'section' => 'vw_church_grid_layout_settings'
  	)));
	...
	$wp_customize->add_setting('vw_church_bradcrumbs_alignment',array(
        'default' => 'Left',
        'sanitize_callback' => 'vw_church_sanitize_choices'
	));
	$wp_customize->add_control('vw_church_bradcrumbs_alignment',array(
        'type' => 'select',
        'label' => __('Bradcrumbs Alignment','vw-church'),
        'section' => 'vw_church_left_right',
        'choices' => array(
            'Left' => __('Left','vw-church'),
            'Right' => __('Right','vw-church'),
	...
	$wp_customize->add_setting( 'vw_church_resp_topbar_hide_show',array(
      'default' => 1,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_church_switch_sanitization'
  	));  
 	$wp_customize->add_control( new VW_Church_Toggle_Switch_Custom_Control( $wp_customize, 'vw_church_resp_topbar_hide_show',array(
      'label' => esc_html__( 'Show / Hide Topbar','vw-church' ),
      'section' => 'vw_church_responsive_media'
  	)));

	$wp_customize->add_setting( 'vw_church_stickyheader_hide_show',array(
      'default' => 0,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_church_switch_sanitization'
    ));
    $wp_customize->add_control( new VW_Church_Toggle_Switch_Custom_Control( $wp_customize, 'vw_church_stickyheader_hide_show',array(
      'label' => esc_html__( 'Show / Hide Sticky Header','vw-church' ),
      'section' => 'vw_church_responsive_media'
    )));
    ...
    $wp_customize->add_setting( 'vw_church_responsive_preloader_hide',array(
        'default' => false,
        'transport' => 'refresh',
        'sanitize_callback' => 'vw_church_switch_sanitization'
    ) );
    $wp_customize->add_control( new VW_Church_Toggle_Switch_Custom_Control( $wp_customize, 'vw_church_responsive_preloader_hide',array(
        'label' => esc_html__( 'Show / Hide Preloader','vw-church' ),
        'section' => 'vw_church_responsive_media'
    )));
  ...
  $wp_customize->add_setting('vw_church_single_product_layout',array(
    ...
    //Products per page
    $wp_customize->add_setting('vw_church_products_per_page',array(
		'default'=> '9',
		'sanitize_callback'	=> 'vw_church_sanitize_float'
	));
	$wp_customize->add_control('vw_church_products_per_page',array(
		'label'	=> __('Products Per Page','vw-church'),
		'description' => __('Display on shop page','vw-church'),
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
			'max'              => 50,
    ...
    //Products per row
    $wp_customize->add_setting('vw_church_products_per_row',array(
		'default'=> '3',
		'sanitize_callback'	=> 'vw_church_sanitize_choices'
	));
	$wp_customize->add_control('vw_church_products_per_row',array(
		'label'	=> __('Products Per Row','vw-church'),
		'description' => __('Display on shop page','vw-church'),
		'choices' => array(
            '2' => '2',
			'3' => '3',
	...
	*/
	public function sections( $manager ) {
		...
		$manager->add_section( new VW_Church_Customize_Section_Pro( $manager,'vw_church_go_pro', array(
			...
			'pro_url'  => esc_url('https://www.themescaliber.com/products/religion-wordpress-theme'),
		) )	);
		...
		$manager->add_section(new VW_Church_Customize_Section_Pro($manager,'vw_church_get_started_link',array(
			...
			'pro_url'  => esc_url('https://preview.themescaliber.com/doc/free-religion/'),
		)));
	}
