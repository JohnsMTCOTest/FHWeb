<?php
	...
	if($vw_church_first_color != false){
		$vw_church_custom_css .='.search-box i, #slider .carousel-control-next i:hover, #slider .carousel-control-prev i:hover, #slider .more-btn a, .more-btn a, #comments input[type="submit"],#comments a.comment-reply-link,input[type="submit"],.woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button,.woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt,nav.woocommerce-MyAccount-navigation ul li,.pro-button a, .woocommerce a.added_to_cart.wc-forward, #preloader, #footer .tagcloud a:hover, #footer input[type="submit"], #footer-2, #footer .wp-block-search .wp-block-search__button, #sidebar .wp-block-search .wp-block-search__button, .scrollup i, #sidebar .custom-social-icons a,#footer .custom-social-icons a, #sidebar h3,  #sidebar .widget_block h3, #sidebar h2, #sidebar .tagcloud a:hover, .pagination a:hover, .pagination .current, .woocommerce span.onsale, .toggle-nav i,.horizontal-text,.header-button a,.page-template-custom-home-page .home-page-header .top-bar .social-icon a,.home-page-header .top-bar .social-icon a,.bradcrumbs span,.bradcrumbs a:hover,.main-navigation ul li a::before, .main-navigation .current_page_item > a::before, .main-navigation .current-menu-item > a::before,.control-section-vw-church h3.accordion-section-title ,#preloader,.header-search, .woocommerce button.button:disabled, .woocommerce button.button:disabled[disabled],#events-section h2:after,.bradcrumbs a:hover,.post-categories li a:hover ,.bradcrumbs span, .wp-block-button__link, #sidebar label.wp-block-search__label, #sidebar .wp-block-heading, .wp-block-tag-cloud a:hover, nav.navigation.posts-navigation .nav-previous a, nav.navigation.posts-navigation .nav-previous a:hover, nav.navigation.posts-navigation .nav-next a:hover,.wc-block-components-order-summary-item__quantity,.wp-block-woocommerce-cart .wc-block-cart__submit-button, .wc-block-components-checkout-place-order-button, .wc-block-components-totals-coupon__button,.wp-block-woocommerce-cart .wc-block-cart__submit-button:hover, .wc-block-components-checkout-place-order-button:hover{';
			$vw_church_custom_css .='background: '.esc_attr($vw_church_first_color).'!important;';
		$vw_church_custom_css .='}';
	}
	...
	if($vw_church_resp_slider == true && get_theme_mod( 'vw_church_slider_hide_show', true) == false){
	...
	if($vw_church_resp_menu_toggle_btn_bg_color != false){
		$vw_church_custom_css .='.toggle-nav i,.sidenav .closebtn{';
	...
	$vw_church_slider_height = get_theme_mod('vw_church_slider_height','600px');
	...
	if($vw_church_copyright_alingment != false){
		$vw_church_custom_css .='.copyright p,#footer-2 p{';
	...
	$vw_church_resp_stickycopyright = get_theme_mod( 'vw_church_stickycopyright_hide_show',false);
	if($vw_church_resp_stickycopyright == true && get_theme_mod( 'vw_church_copyright_sticky',false) != true){
    	$vw_church_custom_css .='.copyright-sticky{';
			$vw_church_custom_css .='position:static;';
		$vw_church_custom_css .='} ';
	}

	$vw_church_footer_social_icons_font_size = get_theme_mod('vw_church_footer_social_icons_font_size','16');
	$vw_church_custom_css .='.copyright .widget i{';
		$vw_church_custom_css .='font-size: '.esc_attr($vw_church_footer_social_icons_font_size).'px;';
	$vw_church_custom_css .='}';

	$vw_church_align_footer_social_icon = get_theme_mod('vw_church_align_footer_social_icon');
	if($vw_church_align_footer_social_icon != false){
		$vw_church_custom_css .='.copyright .widget{';
			$vw_church_custom_css .='text-align: '.esc_attr($vw_church_align_footer_social_icon).';';
		$vw_church_custom_css .='}';
		$vw_church_custom_css .='
		@media screen and (max-width:720px) {
			.copyright .widget{';
	...
	if($vw_church_featured_image_box_shadow != false){
		$vw_church_custom_css .='.box-image img, #content-vw img{';
	...
	$vw_church_singlepost_image_box_shadow = get_theme_mod('vw_church_singlepost_image_box_shadow',0);
	if($vw_church_singlepost_image_box_shadow != false){
		$vw_church_custom_css .='.feature-box img{';
			$vw_church_custom_css .='box-shadow: '.esc_attr($vw_church_singlepost_image_box_shadow).'px '.esc_attr($vw_church_singlepost_image_box_shadow).'px '.esc_attr($vw_church_singlepost_image_box_shadow).'px #cccccc;';
		$vw_church_custom_css .='}';
	}

	$vw_church_related_image_box_shadow = get_theme_mod('vw_church_related_image_box_shadow',0);
	if($vw_church_related_image_box_shadow != false){
		$vw_church_custom_css .='.related-post .box-image img{';
			$vw_church_custom_css .='box-shadow: '.esc_attr($vw_church_related_image_box_shadow).'px '.esc_attr($vw_church_related_image_box_shadow).'px '.esc_attr($vw_church_related_image_box_shadow).'px #cccccc;';
		$vw_church_custom_css .='}';
	}
	...
	if($vw_church_slider_hide_show == true){
		$vw_church_custom_css .='.page-template-custom-home-page .home-page-header{';
	...
	if($vw_church_slider_image_overlay_color != false){
		$vw_church_custom_css .='#slider{';
			$vw_church_custom_css .='background: '.esc_attr($vw_church_slider_image_overlay_color).';';
		$vw_church_custom_css .='}';
	}
	...
	$vw_church_button_letter_spacing = get_theme_mod('vw_church_button_letter_spacing');
	$vw_church_custom_css .='.post-main-box .more-btn a{';
	...
	$vw_church_responsive_preloader_hide = get_theme_mod('vw_church_responsive_preloader_hide',false);
	if($vw_church_responsive_preloader_hide == true && get_theme_mod('vw_church_loader_enable',false) == false){
		$vw_church_custom_css .='@media screen and (min-width:575px){
			#preloader{';
			$vw_church_custom_css .='display:none !important;';
		$vw_church_custom_css .='} }';
	}

	if($vw_church_responsive_preloader_hide == false){
		$vw_church_custom_css .='@media screen and (max-width:575px){
			#preloader{';
			$vw_church_custom_css .='display:none !important;';
		$vw_church_custom_css .='} }';
	...
	$vw_church_resp_stickyheader = get_theme_mod( 'vw_church_stickyheader_hide_show',false);
	if($vw_church_resp_stickyheader == true && get_theme_mod( 'vw_church_sticky_header',false) != true){
    	$vw_church_custom_css .='.header-fixed{';
			$vw_church_custom_css .='position:static;';
		$vw_church_custom_css .='} ';
	}
    if($vw_church_resp_stickyheader == true){
    	$vw_church_custom_css .='@media screen and (max-width:575px) {';
		$vw_church_custom_css .='.header-fixed{';
			$vw_church_custom_css .='position:fixed;';
		$vw_church_custom_css .='} }';
	}else if($vw_church_resp_stickyheader == false){
		$vw_church_custom_css .='@media screen and (max-width:575px){';
		$vw_church_custom_css .='.header-fixed{';
			$vw_church_custom_css .='position:static;';
		$vw_church_custom_css .='} }';
	...
	$vw_church_resp_topbar = get_theme_mod( 'vw_church_resp_topbar_hide_show',true);
	if($vw_church_resp_topbar == true && get_theme_mod( 'vw_church_hide_show_topbar_section', true) == false){
    	$vw_church_custom_css .='.top-bar{';
			$vw_church_custom_css .='display:none;';
		$vw_church_custom_css .='} ';
	}
    if($vw_church_resp_topbar == true){
    	$vw_church_custom_css .='@media screen and (max-width:575px) {';
		$vw_church_custom_css .='.top-bar{';
			$vw_church_custom_css .='display:block;';
		$vw_church_custom_css .='} }';
	}else if($vw_church_resp_topbar == false){
		$vw_church_custom_css .='@media screen and (max-width:575px) {';
		$vw_church_custom_css .='.top-bar{';
			$vw_church_custom_css .='display:none;';
		$vw_church_custom_css .='} }';
	...
	$vw_church_bradcrumbs_alignment = get_theme_mod( 'vw_church_bradcrumbs_alignment','Left');
    if($vw_church_bradcrumbs_alignment == 'Left'){
    	$vw_church_custom_css .='@media screen and (min-width:768px) {';
		$vw_church_custom_css .='.bradcrumbs{';
			$vw_church_custom_css .='text-align:start;';
		$vw_church_custom_css .='}}';
	}else if($vw_church_bradcrumbs_alignment == 'Center'){
		$vw_church_custom_css .='@media screen and (min-width:768px) {';
		$vw_church_custom_css .='.bradcrumbs{';
			$vw_church_custom_css .='text-align:center;';
		$vw_church_custom_css .='}}';
	}else if($vw_church_bradcrumbs_alignment == 'Right'){
		$vw_church_custom_css .='@media screen and (min-width:768px) {';
		$vw_church_custom_css .='.bradcrumbs{';
			$vw_church_custom_css .='text-align:end;';
		$vw_church_custom_css .='}}';
	}
